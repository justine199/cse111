# Enhancement: Added element count display for user clarity
...
def main():
    ...
    # Enhancement: Display the individual element counts
    print("\nElement breakdown:")
    for symbol, quantity in symbol_quantity_list:
        element_name = periodic_table[symbol][NAME_INDEX]
        print(f"{element_name} ({symbol}): {quantity}")

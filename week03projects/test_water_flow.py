...
def test_pressure_in_psi():
    assert pressure_in_psi(0.0) == approx(0.0, abs=0.001)
    assert pressure_in_psi(100.0) == approx(14.5038, abs=0.001)
    assert pressure_in_psi(158.7) == approx(23.002, abs=0.001)
